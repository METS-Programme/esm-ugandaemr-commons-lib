...
export const OverflowMenu: React.FC<OverflowMenuProps> = ({
  ...
  return (
    <div
      className={`cds--overflow-menu ${styles.overflowMenuContainer}`}
      ref={wrapperRef}
    >
      {overflowItems.length > 0 ? (
        <>
          <button
            className={`cds--overflow-menu__trigger ${
              showMenu && "cds--overflow-menu--open"
            }`}
            aria-haspopup="true"
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          const processedForm = applyFormIntent(
                            intent,
                            item.formJson
                          );
