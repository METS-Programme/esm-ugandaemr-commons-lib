...
export const linkedToCareYesValueConcept =
...
export const covidClientsWithPendingLabResults =
  "166aa2b1-ce55-4d16-9643-ca9d2e2694ea";
export const clientsWithoutCovidOutcomes =
  "db6c4a18-28c6-423c-9da0-58d19e364a7f";
...
export const careAndTreatmentEncounterType =
  "7e54cd64-f9c3-11eb-8e6a-57478ce139b0";
export const dateOfServiceEnrollmentConcept =
  "160555AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
export const patientTypeEnrollmentConcept =
  "83e40f2c-c316-43e6-a12e-20a338100281";
export const studyPopulationTypeConcept =
  "d3d4ae96-8c8a-43db-a9dc-dac951f5dcb3";
...
// Encounter types
export const htsRetrospectiveEncounterType =
  "79c1f50f-f77d-42e2-ad2a-d29304dde2fe";
export const covidCaseAssessmentEncType =
...
export const covidReasonsForTestingConcep_UUID =
  "ae46f4b1-c15d-4bba-ab41-b9157b82b0ce"; // Reasons for testing
...
export const covidSpecimenCollectiDate_UUID =
  "159951AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // Date specimen collected
export const covidPatientStatusUUID = "de3bc9b7-05b5-41b6-a38d-8d2eec646c4f"; // Client Health Status

export const covidTreatementOutConcept_UUID =
  "a845f3e6-4432-4de4-9fff-37fa270b1a06";
export const covidSARS_TestResultConcept_UUID =
  "89feed9c-1dd9-477a-ab1c-86f5f75f6762";

// Covid Assessment
export const covidSARS_TestResult_Name_UUID =
  "0961651c-d52e-41dd-957a-94b9ce08e4eb";
export const covidReasonsForTestingUUID =
  "5793ad0f-d726-4918-a1b5-f25f4fb2b857";
export const covidTreatmenOutConceptName_UUID =
  "28d43e48-3673-4671-a6b1-3ed45fdfcba6";
export const covidSpecimentTestDate_UUID =
  "499df97a-2a34-4562-946a-3c4d5608b67f";
export const covidTypeofTestConcept_UUID =
  "069f6dfe-88c1-4a45-a894-0d99549c8718";
export const covidSymptosConcept_UUID = "";
export const covidPresentSymptonsConcept_UUID =
  "244b0dc0-eb1b-46ae-b62a-f580345d4f46";
export const covidComorbidityPresentConcept_UUID =
  "166020AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
export const covidUnderComorbidityConcept_UUID =
  "0651869c-6e90-48d6-b25c-406270c76bee";
export const covidPresentSymptonsName_UUID =
  "12568215-ae1c-42ec-b7e8-8818d2761f46";
export const covidPatientStatusConcept_UUID =
  "de3bc9b7-05b5-41b6-a38d-8d2eec646c4f";
...
export const covidLabOrderEncounterType_UUID =
  "a77d3e7f-5c8f-4074-a207-77a70e197b0c";
...
//Covid Lab Results
export const covidSpecimenCollectionDate_UUID =
  "159951AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
export const covidLabResultsEncounterType_UUID =
  "253a43d3-c99e-415c-8b78-ee7d4d3c1d54";
export const covidSpecimentTypeConcept_UUID =
  "ae127f82-1861-4165-ac81-8554e5a3aac4";
export const covidTestResultConcept_UUID =
  "161934AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
export const covidRapidTestResultDate_UUID =
  "af159c77-bc5d-46dd-90d9-bcbffb22267f";
export const covidDiagnosticPcrResult_UUID =
  "3f4ee14b-b4ab-4597-9fe9-406883b63d76";
export const covidDiagnorticPcrResultDate_UUID =
  "4a77ab44-0323-490e-96be-e168c0e5c9de";
export const covidTestStatusConcept_UUID =
  "6681366c-2174-489a-b951-13a1404935bf";
export const covidTestResultDate_UUID = "163724AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";

// Covid Vaccination
export const covidVaccinationEncounterUUID =
  "5b37ce7a-c55e-4226-bdc8-5af04025a6de";
export const covidVaccinationStatusUUID =
  "40cb816f-797b-4cb4-a9fb-2727b2373623"; // Has the patient been vaccinated
export const covidVaccinationStatusConcept_UUID =
  "de3bc9b7-05b5-41b6-a38d-8d2eec646c4f"; // What is the patient status with regard to COVID-19?
export const covidVaccination1stDoseDateConcept_UUID =
  "c85eb064-5ef7-4ac6-8e56-4749bd58df44"; // What is COVID-19 vaccination date (1st dose)?
export const covidVaccination2ndDoseDateConcept_UUID =
  "42ee7f5c-fdd3-48c1-8d3a-5c6e248e6cb9"; // What is COVID-19 vaccination date (2nd dose)?
export const covidVaccinationTypeConcept_UUID =
  "a31d1148-bbcc-4ad6-a015-8359d66bcfdc"; // What COVID-19 vaccine was administered?
export const covidVaccinationAdministeredConcept_UUID =
  "1410AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"; // Which date COVID-19 vaccine was administered?
export const covidVaccinationNextVacinationDateConcept_UUID =
...
// HIV Lab Results
export const hivLabResultsEncounterType_UUID =
  " 15272be5-ae9c-4278-a303-4b8907eae73b";
export const hivLabTestResultConcept_UUID = "";
export const hivReasonViralLoadRequest_UUID =
  "86cc0cfe-bace-4969-94b6-d139f4971d13";
export const hivReasonCD4Request_UUID = "759e89a6-3260-4aee-9922-86a6301bcff3";
export const hivDateViralLoadResult_UUID =
  "163281AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
export const hivDateViralLoadInterpretation_UUID =
  "686dc1b2-68b5-4024-b311-bd2f5e3ce394";
...
export const deathFormEncounterType_UUID =
  "111c2104-991d-4b58-a30e-ce84bb275534";

//Transfer Out
export const transferOutEncounterType_UUID =
  "3044916a-7e5f-478b-9091-803233f27f91";
...
export const PatientTracingEncounterType_UUID =
  "0cd5d4cb-204e-419a-9dd7-1e18e939ce4c";

//Intimate Partner
export const IntimatePartnerEncounterType_UUID =
  "881fff34-b4a9-4d11-b2f5-a8a23a9f402b";
...
export const howOftenSexuallyMolested_UUID =
  "1dd53a22-2e8f-425b-8ba4-59172ed3fafe";

//Contact Tracing
export const ContactTracingEncounterType_UUID =
  "570e9e42-4306-41dc-9bf8-634bbc70a524";
...
export const ContactTracingOutcome_UUID =
  "36a3e671-9d60-4109-b41f-046f44f4b389";

//Service Delivery
export const ServiceDeliveryEncounterType_UUID =
  "62ee5922-a229-48d3-a1da-875c1ffa9436";
export const CommunityDSDModel_UUID = "52824cbe-0e4d-4c18-8179-80b5799f34ed";

//Peads Disclosure
export const PeadsDisclosureEncounterType_UUID =
  "390c2f21-c1c4-4246-94ca-a026157cd1db";
...
//Patner Notification
export const PatnerNotificationEncounterType_UUID =
  "4dd0ee63-805f-43e9-833c-6386ba97fdc1";
export const IndexHIVStatus_UUID = "1436AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
export const PatnerNotificationContactDate_UUID =
  "160753AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
